 ...
 *
 * Disassembly of dsdt.dat, Thu Mar 17 10:52:22 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000FA85 (64133)
 *     Revision         0x02
 *     Checksum         0x4B
 *     OEM ID           "INTEL "
 *     OEM Table ID     "FCBYT10H"
 *     OEM Revision     0x00000003 (3)
 *     Compiler ID      "AMI "
 *     Compiler Version 0x0100000D (16777229)
 */
DefinitionBlock ("dsdt.aml", "DSDT", 2, "INTEL ", "FCBYT10H", 0x00000003)
{
    /*
    ...
    Name (ACPH, 0xDE)
    Name (FTBL, 0x04)
    OperationRegion (GNVS, SystemMemory, 0x79FD5A98, 0x0334)
    ...
    Scope (_SB)
    {
        ...
        Device (I2C4)
        {
            ...
            Device (TCS2)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSSL & 0x80))
                    {
                        Return (ABUF) /* \_SB_.I2C4.TCS2._CRS.ABUF */
                    }
                    Else
                    {
        ...
        PowerResource (P28P, 0x05, 0x0008)
        {
            Name (_DEP, Package (0x02)  // _DEP: Dependencies
            {
                I2C5, 
        ...
        PowerResource (P18P, 0x05, 0x0002)
        {
            Name (_DEP, Package (0x02)  // _DEP: Dependencies
            {
                I2C5, 
        ...
        PowerResource (P28T, 0x05, 0x0008)
        {
            Name (_DEP, Package (0x02)  // _DEP: Dependencies
            {
                I2C5, 
        ...
        PowerResource (P18T, 0x05, 0x0002)
        {
            Name (_DEP, Package (0x02)  // _DEP: Dependencies
            {
                I2C5, 
