 ...
 *
 * Disassembly of dsdt.dat, Thu Mar 17 15:04:06 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000F262 (62050)
 *     Revision         0x02
 *     Checksum         0xB2
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("dsdt.aml", "DSDT", 2, "ALASKA", "A M I ", 0x00000003)
{
    ...
    Name (ACPH, 0xDE)
    Name (FTBL, 0x04)
    OperationRegion (GNVS, SystemMemory, 0x3C4B8A98, 0x0334)
        ...
        Device (I2C2)
        {
            ...
            Device (TCS1)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C2.TCS1._CRS.RBUF */
                }
